...
def dijkstra_window():
    ...
    # Display distance table (styled like in comparison_view)
...
optimization_button.grid(row=1, column=8, padx=5, pady=5)
optimization_button_pso.grid(row=1, column=7, padx=5, pady=5)
comparison_button.grid(row=1, column=9, padx=5, pady=5)
...
clear_button.grid(row=1, column=10, padx=5, pady=5)
